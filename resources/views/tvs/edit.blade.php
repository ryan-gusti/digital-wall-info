...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('tvs.update', $tv) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"
                               ...
                               id="ip_address"
                               name="ip_address"
                               value="{{ old('ip_address', $tv->ip_address) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"
                               ...
                               id="location"
                               name="location"
                               value="{{ old('location', $tv->location) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror"
                                  id="description"
                                  name="description"
                                  rows="3">{{ old('description', $tv->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <select class="form-select @error('playlist_id') is-invalid @enderror"
                            ...
                            @foreach($playlists as $playlist)
                                <option value="{{ $playlist->id }}" 
                                        {{ old('playlist_id', $tv->playlist_id) == $playlist->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input"
                                   ...
                                   name="is_active"
                                   value="1"
                                   {{ old('is_active', $tv->is_active) ? 'checked' : '' }}>
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('tvs.show', $tv) }}" class="btn btn-secondary">
